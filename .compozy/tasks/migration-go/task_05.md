---
status: completed
title: API de anos letivos (CRUD, class_days, janela de inscrição)
type: backend
complexity: medium
dependencies:
  - task_03
...
## Subtasks
- [x] 5.1 Queries sqlc (list, create, update, delete)
- [x] 5.2 Handlers + validação de payload (incl. class_days 0–6)
- [x] 5.3 Mapear erros PG (23505/23503) para 409
- [x] 5.4 Rotas montadas no router com gate de coordenador
- [x] 5.5 Testes de handler e integração
...
## Tests
- Unit:
  - [x] validação de class_days e janela
  - [x] ano duplicado → 409
- Integração:
  - [x] CRUD ponta a ponta; DELETE com turmas vinculadas → 409
